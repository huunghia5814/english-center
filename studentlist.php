...
<?php error_reporting(0) ?>
	<div id="contentWrapper" > 
		...
		<div id="mainContent">
		<h2 color='red' ><a href="addstudent.php">Thêm Học sinh</a></h2>
	...
	echo "<td width='80' ><a href='edit_student.php?studentid=$row[MaHV]'>Edit</a></td>";
	echo "<td width='80' ><a href='del_student.php?studentid=$row[MaHV]'>Del</a></td>";
	echo "</tr>";
	echo "</table>";
	}
	}
