...
<?php error_reporting(0) ?>
	<div id="contentWrapper" > 
		...
		<div id="mainContent">
		<h2 color='red' ><a href="addgiaovien.php">Thêm giáo viên</a></h2>

	<table align='center' width='800' border='1'>
	<tr>
	<td width='80'>STT</td>
	<td width='80'>Mã GV</td>
	<td width='80'>Tên</td>
	...
	echo "<td width='80' ><a href='classlist_toteach.php?classlistid=$row[MaLop]'>$row[MaGV]</a></td>";
	echo "<td width='80' >$row[TenGV]</td>";
	echo "<td width='80' >$row[MaLop]</td>";
	echo "<td width='80' >$row[NgaySinh]</td>";
	echo "<td width='80' >$row[Phai]</td>";
	echo "<td width='80' ><a href='edit_teacher.php?teacherid=$row[MaGV]'>Edit</a></td>";
	echo "<td width='80' ><a href='del_teacher.php?teacherid=$row[MaGV]'>Del</a></td>";
	echo "</tr>";
	echo "</table>";
	}
	}
